 ...
 *      总结：
 *      ->左边:lambda的形参列表的参数类型可以省略(类型推断)；如果lambda形参列表只有一个参数，其一对()也可以省略
...
public class LambdaTest1 {
    ...
    public void test1(){
        ...
        Runnable r2 =()-> System.out.println("我爱apex");
        r2.run();
    }
