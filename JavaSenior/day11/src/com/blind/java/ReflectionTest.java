...
public class ReflectionTest {
    ...
    public void test3() throws ClassNotFoundException {
        ...
        System.out.println(clazz1);//class com.blind.java.Person
        //方式二：通过运行时类的对象，调用getClass()
        Person p1 = new Person();
        Class clazz2 = p1.getClass();
        System.out.println(clazz2);//class com.blind.java.Person

        //方式三：调用Class的静态方法：forName(String classPath)
        Class clazz3 = Class.forName("com.blind.java.Person");
//        clazz3 = Class.forName("java.lang.String");
        ...
        Class clazz4 = classLoader.loadClass("com.blind.java.Person");
